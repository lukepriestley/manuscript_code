...
timecourse_dir = '/Volumes/Lacie/neuron_submission/data/fmri/tc_data/';
addpath /Volumes/Lacie/neuron_submission/fmt; 
tc_graph_dir = '/Volumes/Lacie/neuron_submission/data/fmri/tc_output';

behav = readtable('/Volumes/Lacie/neuron_submission/data/fmri/fmri_behaviour_with_glmhmm.csv');
...
% Subcortical ROI list: 'HB_LP_decision', 'DRN_decision', 'VTA_decision', 'NB_decision', 'SN_decision', 'LC_decision', 'MRN_decision', 'vent_decision'
% Cortical ROI list: 'AI_func_decision', 'SMA_decision', 'ACC_func_decision'

roi = {'DRN_decision'}; % select ROIs for GLM
% seed_roi = {}; roi = {}; % select ROIs for PPI

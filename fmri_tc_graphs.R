...
# Create the ggplot
fig5a1 <- ggplot(filtered_data, aes(
  x = timepoint, y = m, ymin = m - se, ymax = m + se
)) +
  geom_hline(yintercept = 0, linetype = 1, alpha = 0.1) +
  geom_vline(xintercept = 0, linetype = 1, alpha = 0.1) +
...
# Create the ggplot
fig5a2 <- ggplot(filtered_data, aes(
...
# Create the ggplot
fig5a3 <- ggplot(filtered_data, aes(
  x = timepoint, y = m, group = glm, fill = glm, ymin = m - se, ymax = m + se
)) +
  geom_hline(yintercept = 0, linetype = 1, alpha = 0.1) +
  geom_vline(xintercept = 0, linetype = 1, alpha = 0.1) +
...
# Create the ggplot
fig5b2 <- ggplot(filtered_data, aes(
  x = timepoint, y = m, group = glm, fill = glm, ymin = m - se, ymax = m + se
)) +
  geom_hline(yintercept = 0, linetype = 1, alpha = 0.1) +
  geom_vline(xintercept = 0, linetype = 1, alpha = 0.1) +
...
# Create the ggplot
fig5b3 <- ggplot(filtered_data, aes(
  x = timepoint, y = m, ymin = m - se, ymax = m + se
)) +
  geom_hline(yintercept = 0, linetype = 1, alpha = 0.1) +
  geom_vline(xintercept = 0, linetype = 1, alpha = 0.1) +
...
fig3e_inset <- ggplot(data = d_peak %>%
  ...
  stat_summary(fun.data = 'mean_se', geom = 'errorbar', color = 'black', width = 0.20, size = 1) + 

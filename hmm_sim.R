...
############### simulate data ##################
hmm_path <- '/Volumes/Lacie/neuron_submission/data/behaviour/glm_hmm_fits/fmri/'
...
fig.2f <- ggplot(combined_acf_results %>% filter(Lag != '0' & n_hmm_states < 3), 
...
################## Richness and Prev. response effects (FIGURE 2H-I) ###################
